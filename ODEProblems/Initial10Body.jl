function Initial10Body(T=Float64)
...
GmJupyter = parse(BigFloat,"0.282534584083387000e-6")
GmSaturn =  parse(BigFloat,"0.845970607324503000e-7")
GmUranus= parse(BigFloat,"0.129202482578296000e-7")
GmNeptune = parse(BigFloat,"0.152435734788511000e-7")
GmPluto=  parse(BigFloat,"0.217844105197418000e-11")

Gm = [GmSun,GmMercury, GmVenus,
  GmEarth + GmMoon, GmMars,
  GmJupyter, GmSaturn, GmUranus, GmNeptune,
  GmPluto]
