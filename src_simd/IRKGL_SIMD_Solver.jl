...
#    Dmin = zero(u0)
    ...
    irkgl_cache = IRKGL_SIMD_Cache(f,p,b,c,mu,nu,theta,omega,alpha,g,d,s_beta,
                                   U, U_, L, dU,
      ...
      while cont
        ...
        for i in 1:m
            ...
            if step_number[] ==1
               ...
               (status,j_iter) = IRKGLstep_SIMD_adap!(tj,tf, uj,ej,prob,dts,irkgl_cache)
            end
            ...
            if tout[]<tj[1]+tj[2]
                ...
                init_interp=0
                (status_,j_iter_) = IRKGLstep_SIMD_fixed!(tj_,tf, uj_,ej_,prob,dts_,irkgl_cache)
